  ...
  <div class="shadow-lg p-3 mb-5 bg-white rounded">
    ...
    <div class="text-center my-5">
            <h1>ログインする</h1><br>  
                ...
                <div class="btn d-flex justify-content-around">
                    <button type="button" class="btn btn-success w-50 m-2"><i class="fab fa-line">　LINEでログイン　</i></button>
                </div>
                <div class="m-2"><br>
                </div>              
    </div>
    ...
    <form>
     <div class="text-center my-5">
            <h4>メールアドレスまたはIDでログイン</h4><br><br>
        <div class="form-row text-left justify-content-center">
            <label class="col-sm-8 col-sm-offset-2"> メールアドレスまたはID
            </label>
            <div class="col-sm-8">
                <!--入力がメールアドレスの場合-->
                <p> 
