      ...
      <!-- 以下、記事情報表示画面 -->
        <div class="row col py-4 justify-content-center">
            ...
            <div class="mt-2 col-md-3 w-50">
                ...
                <img src="/assets/image/5/detail/17/thum/5f7191ae805b1.jpg" class="card-img img-thumbnail" alt="icon_image">
                </div>
            </div>
            ...
            <div class="col-md d-flex flex-column mt-2">
                ...
                <div class="row d-flex flex-row" >
                    <div class="col-8 text-left m-1 mx-auto">
                        <h4 class="font-weight-bold text-center text-nowrap">連載タイトル</h4>
