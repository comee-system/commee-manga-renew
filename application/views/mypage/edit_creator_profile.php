...
<div class="main-contents container">
  ...
  <form method="POST" action="#">
    ...
    <!-- 以下、クリエイタープロフィール編集画面 -->
    <div class="container2 pt-4 bg-light">
      <div class="row">

        <!-- アイコン変更 -->
        <div class="col-4 my-auto pt-5">
          <div class="card card bg-light border border-0">
        ...
        <div class="col-8 d-flex flex-column mt-2">
          ...
          <div class="p-2 text-left">
            <div class="form-group">
                <label for="profileTextarea1">プロフィールをお書きください。</label>
                <textarea class="form-control" id="profileTextarea" rows="8" placeholder=">It was beautiful, historical, artistically subtle in a way that science can’t capture, and I found it fascinating. None of this had even a hope of any practical application in my life. But ten years later, when we were designing the first Macintosh computer, it all came back to me. And we designed it all into the Mac. It was the first computer with beautiful typography. If I had never dropped in on that single course in college, the Mac would have never had multiple typefaces or proportionally spaced fonts."></textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="form-row text-left justify-content-center ">
            <div class="col-12">
                <p> <div class="font-weight-bold mx-2">ストア情報(最初は不要)</div></p>
                <div class="mx-2"><p>iichi・STORES・BASE・minne・MUUU・EC-CUBEで、あなたが販売している商品をマイページに表示します。登録方法は右のヘルプをご参照ください。
