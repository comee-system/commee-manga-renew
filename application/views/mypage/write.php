			...
			<div class="mx-auto w-100 mw1170 mt-3" >
				<form action="" method="POST" >
					...
					<div class="form-row">
						...
						<div class="form-group col-4">
							<input type="radio" class="btn-check hide" name="saletype" id="sale_buy" autocomplete="off" checked>
							<label class="btn btn-outline-success w-100" for="sale_buy">買切り</label>
						</div>
						<div class="form-group col-4">
