...
<div class="py-5"></div>
	...
	<!-- COMEEおすすめ -->
	<div class="content2 m-3 p-3 border border rounded">
		<h4>COMEEおすすめ</h4>
		<div class="row flex-row flex-nowrap overflow-auto carousel slide p-4" id="carousel-card" class="carousel slide" data-interval="false">
				<div class="carousel-inner">
	...
	<!-- 新着作品 -->
	<div class="container m-3 p-3 border border rounded test">
		<h4>新着作品</h4>
				...
				<div class="card card-block h-50">
					<div class="card ">
						...
						<div class="card-body test">
							<h5 class="card-title test">タイトル</h5>
							<p class="card-text test"><small class="text-muted">リード文リード文リード文リード文リード文リード文リード文</small></p>
						</div>
						<!-- <div class="card-footer">
						カードのフッター
						</div> -->
