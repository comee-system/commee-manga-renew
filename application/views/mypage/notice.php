...
<div class="main-contents container">
    ...
    <div class="shadow-lg mb-5 bg-white rounded">
        <h3 class="text-center text-dark pl-5 pt-4">通知</h3>
              ...
              　<!-- 通知例(Like、複数人の場合) -->
                    ...
                    <div class="media ml-3">
                        <div class="row col-sm">
                            ...
                            <div class="media-body">
                                <h5 class="py-5 d-flex align-items-center justify-content-center text-dark font-weight-bold">○○さんと他ｘ人がXXXにLikeしました！</h5>
                            </div>   
                        </div>
                    </div>
                </div>
                <div class="pb-3 bg-white"></div>
                 ...
                 <div class="bg-light position-relative">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h5 class="py-5 d-flex justify-content-center text-dark font-weight-bold">○○さんがXXXを投稿しました！</h5>
                ...
                <div class="bg-light position-relative">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h5 class="py-5 d-flex justify-content-center text-dark font-weight-bold">○○さんがあなたを支援しました！</h5>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
