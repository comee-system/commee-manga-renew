  ...
  <div class="main-contents container">
    <div class="shadow-lg p-3 mb-5 bg-white rounded">
      ...
      <form method="POST" action="#">
        ...
        <!-- ユーザーネーム -->
        <div class="form-row text-left justify-content-center">
          <label class="col-sm-9 col-sm-offset-2">ユーザーネーム <span class="badge badge-danger">必須</span><br>（COMEEで表示される名前です）</label><br>
          <div class="col-sm-9">
            <p>
              <input type="text" name="name" autocomplete="name" class="form-control" placeholder="ユーザーネーム" required />
            </p>
          </div>
        </div>
        ...
        <!-- ユーザーID -->
        <div class="form-row text-left justify-content-center mt-3">
          <label class="col-sm-9 col-sm-offset-2">ユーザーID  <span class="badge badge-danger">必須</span><br>
            <small class="text-danger">*5～16文字　半角英数字と_(アンダースコア)が使用できます</small>
          </label>
          <div class="col-sm-9">
            <p>
              <input type="text" name="uid" autocomplete="uid" class="form-control" placeholder="ユーザーID" required />
            </p>
          </div>
        </div>
        ...
        <!-- 登録する -->
        <div class="text-center my-5">
          <input type="submit" value="登録する" class="btn btn-success btnflex mb-5">
        </div>
      </form>
